...
-- Add detailed sales funnel columns
ALTER TABLE public.metrics_snapshot
  ADD COLUMN IF NOT EXISTS calls_made INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS calls_reached INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS calls_interested INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS closings_planned INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS closings_held INTEGER DEFAULT 0;
